...
<script>
    function getData() {
        $.ajax({
            url: "<?= base_url(); ?>/admin/lomba/getData",
            dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".tombolTambah", function() {
            $.ajax({
                url: "<?= base_url(); ?>/admin/lomba/tambah",
                dataType: "json",
                beforeSend: function() {
                    $('.tombolTambah').hide();
        ...
        $(document).on("submit", "#form-tambah-lomba", function(e) {
            e.preventDefault();

            $.ajax({
                url: '<?= base_url(); ?>/admin/lomba/save',
                type: 'post',
                dataType: 'json',
                data: $(this).serialize(),
                beforeSend: function() {
        ...
        $(document).on("submit", "#form-update-lomba", function(e) {
            e.preventDefault();

            $.ajax({
                url: '<?= base_url(); ?>/admin/lomba/update',
                type: 'post',
                data: $(this).serialize(),
                dataType: 'json',
                beforeSend: function() {
        ...
        $(document).on('click', '.btnHapus', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url(); ?>/admin/lomba/hapus",
                        data: {
                            id: id
                        },
                        beforeSend: function() {
