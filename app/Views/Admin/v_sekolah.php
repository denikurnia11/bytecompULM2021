...
<script>
    function getData() {
        $.ajax({
            url: "<?= base_url(); ?>/admin/sekolah/getData",
            dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".tombolTambah", function() {
            $.ajax({
                url: "<?= base_url(); ?>/admin/sekolah/tambah",
                dataType: "json",
                beforeSend: function() {
                    $('.tombolTambah').hide();
        ...
        $(document).on("submit", "#form-tambah-sekolah", function(e) {
            e.preventDefault();
            $.ajax({
        ...
        $(document).on("submit", "#form-edit-sekolah", function(e) {
            e.preventDefault();
        ...
        $(document).on('click', '.btnHapus', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url(); ?>/admin/sekolah/hapus",
                        data: {
                            id: id
                        },
                        beforeSend: function() {
