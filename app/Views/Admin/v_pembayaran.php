...
<script>
    function getData() {
        $.ajax({
            url: "<?= base_url(); ?>/admin/pembayaran/getData",
            dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".tombolTambah", function() {
            $.ajax({
                url: "<?= base_url(); ?>/admin/pembayaran/tambah",
                dataType: "json",
                beforeSend: function() {
                    $('.tombolTambah').hide();
        ...
        $(document).on("submit", "#form-tambah-pembayaran", function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?= base_url(); ?>/admin/pembayaran/save',
                type: 'post',
                dataType: 'json',
        ...
        $(document).on("click", ".btnEdit", function() {
            $.ajax({
                url: "<?= base_url(); ?>/admin/pembayaran/edit",
                dataType: "json",
                data: {
                    id: $(this).attr('id')
                },
        ...
        $(document).on("submit", "#form-edit-pembayaran", function(e) {
            e.preventDefault();

            $.ajax({
                url: '<?= base_url(); ?>/admin/pembayaran/update',
                type: 'post',
                dataType: 'json',
                data: new FormData(this),
                contentType: false,
        ...
        $(document).on('click', '.btnHapus', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url(); ?>/admin/pembayaran/hapus",
                        data: {
                            id: id
                        },
                        beforeSend: function() {
