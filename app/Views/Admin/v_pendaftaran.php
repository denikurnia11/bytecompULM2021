...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".tombolTambah", function() {
            $.ajax({
                url: "<?= base_url(); ?>/admin/pendaftaran/tambah",
                dataType: "json",
                beforeSend: function() {
                    $('.tombolTambah').hide();
        ...
        $(document).on("submit", "#form-tambah-pendaftaran", function(e) {
            e.preventDefault();

            $.ajax({
                url: '<?= base_url(); ?>/admin/pendaftaran/save',
                type: 'post',
                dataType: 'json',
                data: $(this).serialize(),
                beforeSend: function() {
        ...
        $(document).on("click", ".btnEdit", function() {
            $.ajax({
                url: "<?= base_url(); ?>/admin/pendaftaran/edit",
                dataType: "json",
                data: {
                    id: $(this).attr('id')
                },
        ...
        $(document).on("submit", "#form-update-pendaftaran", function(e) {
            e.preventDefault();
        ...
        $(document).on('click', '.btnHapus', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url(); ?>/admin/pendaftaran/hapus",
                        data: {
                            id: id
                        },
                        beforeSend: function() {
